...
public interface MultimediaOfertaRepository extends JpaRepository<MultimediaOferta, Integer> {
    ...
    Optional<MultimediaOferta> findFirstByOferta_IdOfertaAndStatusTrueOrderByIdMultimediaOfertaAsc(Integer idOferta);

    List<MultimediaOferta> findByOferta_IdOfertaAndStatusTrueOrderByIdMultimediaOfertaAsc(Integer idOferta);
